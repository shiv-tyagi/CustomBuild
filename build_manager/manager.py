...
class BuildInfo:
    def __init__(self,
        ...
        Parameters:
            ...
            remote (RemoteInfo): The remote repository containing the source
            commit to build on.
...
class BuildManager:
    ...
    def __init__(self,
        ...
        # as we use pickle for serialization.
    ...
    def get_next_build_id(self) -> str:
        ...
        logger.debug(f"Next build id: {build_id}")
        return build_id
    ...
    def get_running_build_ids(self) -> list:
        """
        Retrieve the IDs of all builds that are currently running.

        Returns:
            list: A list of build IDs that are in the RUNNING state.
        """
        ret = []
